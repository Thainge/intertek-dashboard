...
import { getBusinessUnits, updateSharepointData } from '../Hooks/Sharepoint';
...
function BusinessUnits() {
    ...
    async function fetchSharepointData() {
        setLoading(() => true);
        const responseData = await getBusinessUnits();
        ...
        let filtersLS = ls.get('IntertekFiltersUnits') || 2;
        let foundDay = filtersLS.days === 0 ? 7 : filtersLS.days === 1 ? 30 : 120;
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <div className={styles.h1}>All Business Units</div>
            ...
            <ListTableHeader business={true} setConsultantList={setConsultantList} cleanConsulantList={cleanConsulantList} searchTerm1={'Primary_Consultant'} searchTerm2={'Secondary_Consultant'} />
            <ListTable loadText={'Retrieving business units...'} loading={loading} columns={columns} data={consulantList} />
        </div>
    )
}
